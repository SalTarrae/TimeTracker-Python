...
SECRET_KEY = 'django-insecure-ueep^0f=-di65*_dd(#4#20%wtwtpyo4_-2p)s%qqf0s36ntg#'
...
# RestFramework Authentication Configuration
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.SessionAuthentication',  # For testing in the browser
